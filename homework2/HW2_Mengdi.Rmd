...
From the following regression output, this regression has 42 coefficients in total, excluding the intercept. Its R^2^ is 1-7066.8/13003.4 = 0.4565421, indicating that about 45.65% of the variability in the logarithm of the price is explain by the model. Out of the 42 coefficients, 37 are significant under a False Discovery Rate (FDR) of 10%.
...
summary(pricey_drop)
1-7067.8/13003.4 # not dropping "STATE"
```
